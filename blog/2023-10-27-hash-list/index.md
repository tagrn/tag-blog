...
삽입 시간복잡도는 최악의 경우 O(N)이지만 후위 삽입같은 경우에는 기존의 링크드리스트와 같이 O(1)의 시간이 걸리게 됩니다. 또한, 삭제한 요소에 따라 중간 삽입도 O(1)의 시간복잡도를 가질 수 있는 장점이 있습니다.
:::
...
<div style={{"text-align": "right"}}> 최종 업데이트: 2023년 11월 10일 </div>
